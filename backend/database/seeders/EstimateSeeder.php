...
class EstimateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($partners->isEmpty() || $projectTypes->isEmpty()) {
            $this->command->warn('マスターデータが不足しています。先にPartnerSeeder、ProjectTypesSeederを実行してください。');
            return;
        }
        ...
        $estimates = [
            [
                ...
                'subtotal' => 25000000,
                'overhead_rate' => 20.00,
                'overhead_amount' => 5000000,
                'cost_expense_rate' => 3.00,
                'cost_expense_amount' => 750000,
                'material_expense_rate' => 5.00,
                'material_expense_amount' => 1250000,
                'tax_rate' => 0.10,
                'tax_amount' => 2500000,
